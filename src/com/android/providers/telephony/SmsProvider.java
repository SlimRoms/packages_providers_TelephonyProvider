...
public class SmsProvider extends ContentProvider {
    ...
    private static final int PHONE1 = 0;
    private static final int PHONE2 = 1;
    ...
    public Cursor query(Uri url, String[] projectionIn, String selection,
        ...
        switch (match) {
            ...
            case SMS_ALL_ICC: {
                ...
                return getAllMessagesFromIcc(phoneId);
            }
            case SMS_ICC: {
                String messageIndexIcc = url.getPathSegments().get(MESSAGE_ID);
                int phoneId = SubscriptionManager.getPhoneId(
                        SubscriptionManager.getDefaultSmsSubId());
                return getSingleMessageFromIcc(messageIndexIcc, phoneId);
            }
            case SMS_ALL_ICC1:
                return getAllMessagesFromIcc(PHONE1);

            case SMS_ICC1:
                String messageIndexIcc1 = url.getPathSegments().get(MESSAGE_ID);
                return getSingleMessageFromIcc(messageIndexIcc1, PHONE1);

            case SMS_ALL_ICC2:
                return getAllMessagesFromIcc(PHONE2);

            case SMS_ICC2:
                String messageIndexIcc2 = url.getPathSegments().get(MESSAGE_ID);
                return getSingleMessageFromIcc(messageIndexIcc2, PHONE2);
    ...
    private Object[] convertIccToSms(SmsMessage message, int id, int phoneId) {
        ...
        row[1] = message.getDisplayOriginatingAddress();//(type == Sms.MESSAGE_TYPE_INBOX)
    ...
    public int delete(Uri url, String where, String[] whereArgs) {
        ...
        switch (match) {
            ...
            case SMS_ICC:
                ...
                int phoneId = SubscriptionManager.getPhoneId(
                        SubscriptionManager.getDefaultSmsSubId());
                return deleteMessageFromIcc(messageIndexIcc, phoneId);
            case SMS_ICC1:
                String messageIndexIcc1 = url.getPathSegments().get(MESSAGE_ID);

                return deleteMessageFromIcc(messageIndexIcc1, PHONE1);
            case SMS_ICC2:
                String messageIndexIcc2 = url.getPathSegments().get(MESSAGE_ID);

                return deleteMessageFromIcc(messageIndexIcc2, PHONE2);
